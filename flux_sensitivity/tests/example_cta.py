...
irf = fs.io.gamma_astro_data.read_instrument_response_function(path=cta_irf_path)
irf = fs.io.gamma_astro_data.average_instrument_response_over_field_of_view(irf=irf, roi_opening_deg=ROI_OPENING_DEG)

energy_bin_edges_GeV = fs.io.gamma_astro_data.find_common_energy_bin_edges(components=irf)
